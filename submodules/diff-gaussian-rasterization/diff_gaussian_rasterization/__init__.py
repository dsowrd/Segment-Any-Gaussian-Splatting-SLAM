...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, depth, color, objects, radii, is_used, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return depth, color, radii, objects, is_used

    @staticmethod
    def backward(ctx, grad_out_depth, grad_out_color, grad_radii_delete_me, grad_out_objects, grad_is_delete_me):
